    ...
    def __getitem__(self, key):
        try:
            ...
            for k, v in self.items():
                ...
                raise self.error(self.msg, str(e))


class PartNotFoundInFileError(Exception):
    def __init__(self, file, part):
        self.value = f"Can't find the part {part} in file '{file}'. Please make sure part is in the file."

    def __str__(self):
        return self.value


class PartNotFoundInSettingsError(Exception):
    def __init__(self, setting, part):
        self.value = f"Can't find the part {part} in settings '{setting}'. Please make sure part is in setting '{setting}'."
...
def removeLevel(d):
    """
    {'AP17400': {'正檢': {'Bond ring shift': [6323, 6366], 'Scratch': [2010, 2011, 2030], 'Defect on glass': [1123, 6124], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050], 'Contamination': [1000, 1100, 4200], 'Residue': [4110], 'Pattern incomplete': [2120, 6022, 6030, 6110, 6150], 'Pad anomaly': [2230, 3030, 4130, 4530, 6130], 'FS others': [1110, 2100, 3111, 6610, 8300, 8887]}, '背檢': {'Contamination': [1094], 'Film abnormal': [1194, 2094, 2190, 3094, 3095, 6194], 'Missing Die': [6195, 8390], 'Picked die': [8290], 'Street abnormal': [1195, 2090], 'Trench graphic abnormal': [6191], 'BS others': [8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP17407': {'正檢': {'Bond ring shift': [6323, 6366], 'Scratch': [2010, 2011, 2030], 'Defect on glass': [1123, 6124], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050], 'Contamination': [1000, 1100, 4200], 'Residue': [4110], 'Pattern incomplete': [2120, 6022, 6030, 6110, 6150], 'Pad anomaly': [2230, 3030, 4130, 4530, 6130], 'FS others': [1110, 2100, 3111, 6610, 8300, 8887]}, '背檢': {'Contamination': [1094], 'Film abnormal': [1194, 2094, 2190, 3094, 3095, 6194], 'Missing Die': [6195, 8390], 'Picked die': [8290], 'Street abnormal': [1195, 2090], 'Trench graphic abnormal': [6191], 'BS others': [8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP17406': {'正檢': {'Bond ring shift': [6323, 6366], 'Scratch': [2010, 2011, 2030], 'Defect on glass': [1123, 6124], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050], 'Contamination': [1000, 1100, 4200], 'Residue': [4110], 'Pattern incomplete': [2120, 6022, 6030, 6110, 6150], 'Pad anomaly': [2230, 3030, 4130, 4530, 6130], 'FS others': [1110, 2100, 3111, 6610, 8300, 8887]}, '背檢': {'Contamination': [1094], 'Film abnormal': [1194, 2094, 2190, 3094, 3095, 6194], 'Missing Die': [6195, 8390], 'Picked die': [8290], 'Street abnormal': [1195, 2090], 'Trench graphic abnormal': [6191], 'BS others': [8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP1C0': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100, 1123], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [3011, 6022, 6030, 6110, 6124, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391, 6198], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 6094], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'Glass defect': [2093, 6194, 6196, 6197, 6394, 6395], 'Glass Align Shift': [6199], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4]}}, 'AP19702': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'Span': [4], 'RB1': [5], 'RB2': [6], 'SPAT': [8], 'DPAT': [9]}}, 'AP19701': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'Span': [4], 'RB1': [5], 'RB2': [6], 'SPAT': [8], 'DPAT': [9]}}, 'AP19700': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'Span': [4], 'RB1': [5], 'RB2': [6], 'SPAT': [8], 'DPAT': [9]}}, 'AP19603': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP19602': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP19601': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP19600': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP174': {'正檢': {'Bond ring shift': [6323, 6366], 'Scratch': [2010, 2011, 2030], 'Defect on glass': [1123, 6124], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050], 'Contamination': [1000, 1100, 4200], 'Residue': [4110], 'Pattern incomplete': [2120, 6022, 6030, 6110, 6150], 'Pad anomaly': [2230, 3030, 4130, 4530, 6130], 'FS others': [1110, 2100, 3111, 6610, 8300]}, '背檢': {'Contamination': [1094], 'Film abnormal': [1194, 2094, 2190, 3094, 3095, 6194, 8887], 'Missing Die': [6195, 8390], 'Picked die': [8290], 'Street abnormal': [1195, 2090], 'Trench graphic abnormal': [6191], 'BS others': [8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP196': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP197': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'Span': [4], 'RB1': [5], 'RB2': [6], 'SPAT': [8], 'DPAT': [9]}}, 'AP1C5': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP1CC': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP1CC00': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP1CC01': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP198': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 2510, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP191': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 2510, 8887]}, '背檢': {'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4]}}, 'AP148': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Drilled hole anomaly': [6093, 6393], 'Missing Die': [8390], 'Moisture trapped': [5390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'RB1': [4], 'SPAT': [8], 'DPAT': [9]}}, 'AP150': {'正檢': {'Passivation crack': [2150], 'Scratch': [2010, 2011, 2030, 2040, 2050], 'Contamination': [1100], 'ILD hump': [1101], 'Passivation anomaly': [3050, 6050, 6250], 'Particle': [1000, 4200], 'Residue': [4110], 'Dicing anomaly': [5000, 5100, 5200, 5101], 'Missing Die': [8200], 'Pad anomaly': [2230, 3030, 4130, 4330, 6130], 'Pattern incomplete': [6022, 6030, 6110, 6150, 6210], 'FS others': [2111, 6060, 8100, 8500, 1110, 2120, 8887]}, '背檢': {'Bond chuck mark': [2193], 'Cavity damage': [2391, 2392], 'Cavity rough': [2390, 4490, 1490], 'Contamination': [2393, 1291, 1191, 1196], 'Particle': [1091, 1391], 'Residue': [4090], 'Defect on bonding area': [4092, 2092, 4093], 'Missing Die': [8390], 'Picked die': [8290], 'BS others': [2190, 8888]}, 'CP': {'Rin': [2], 'Offset': [3], 'Span': [4], 'RB1': [5], 'RB2': [6], 'SPAT': [8], 'DPAT': [9]}}, 'AP1BF': {'正檢': {'Solder pad area defect': [2030, 1130, 3030, 2330, 4030, 2130, 6130, 2530], 'Protective layer and dielectric layer defect': [1150, 3050, 4050, 6150], 'FS others': [8887]}, '背檢': {'others': [8888]}}, 'AP1BQ': {'CP': {'Layer1 fail': [11], 'Layer2 fail': [12], 'Layer3 fail': [13], 'Layer4 fail': [14], 'Layer5 fail': [15], 'Alignment fail': [16], 'C_sb fail': [2], 'C_bg fail': [3], 'C_sg fail': [4], 'Rs_sb fail': [5], 'Rs_bg fail': [6], 'Rs_sg fail': [7], 'Rp_sb fail': [8], 'Rp_bg fail': [9], 'Rp_sg fail': [10]}}}
    :param d:
    :return:
    """
    # k1: part
...
summary_table_parts = cfg['summary table parts and yield goal']
...
def query_active_code(string=False, to_set=False):
    result = CustomDict(PartNotFoundInFileError, r'code adjustment/Active code by part.xlsx')
...
def goals(part):
    ...
    goal = summary_table_parts.get(part, 0.95)
...
def query_description_dict():
    ...
    """
    result = CustomDict(PartNotFoundInFileError, r'code adjustment/group by part.xlsx')
...
# def query_gross_die():
#     from Database_query import gross_die_by_part, gross_die_modified_dict
#     result = CustomDict(PartNotFoundInSettingsError, 'gross die by part')
...
class QueryGrossDie:
    ...
    def query(self, part):
        try:
            n = self.result[part]
        except PartNotFoundInSettingsError:
            n = gross_die_by_part(part)
            self.result[part] = n
        return n


query_gross_die = QueryGrossDie()

gross_die = query_gross_die.query
...
def int2str(i):
    ...
    try:
        ...
        while i:
            ...
            i //= len(chars)
        return s
    except ValueError:  # input is already string
        i2 = ord(i)
        s = int2str(i2+10000)
        return s
...
def df_weekly_update(df, part):
    ...
    df_pcs_group = result_dict['df_pcs_group']
    df_summary = result_dict['df_summary']
    # add box_plot data to summary
    df_summary = pd.concat([df_summary, df_box_plot(df_pcs_group)], axis=1)
    result_dict['df_summary'] = df_summary
    return result_dict


def df_box_plot(df_pcs_group):
    box_plot_dict = {}
    df_yield = df_pcs_group.loc[:, [('SUMMARY', 'Yield'), ('SUMMARY', 'FSV'), ('SUMMARY', 'BSV'), ('SUMMARY', 'CP')]]
    labels = ['OVERALL_BOX_PLOT', 'FSV_BOX_PLOT', 'BSV_BOX_PLOT', 'CP_BOX_PLOT']
    box_plot_return = ['mean', 'med', 'iqr', 'q1', 'q3', 'cilo', 'cihi', 'whislo', 'whishi', 'fliers']
    box_plot_stats = cbook.boxplot_stats(df_yield.T, labels=labels)

    for d in box_plot_stats:
        l1 = d.pop('label')
        box_plot_dict[l1] = d
    tuples = [(label, n) for label in labels for n in box_plot_return]

    contents = [box_plot_dict[label][n] for label, n in tuples]
    index = pd.MultiIndex.from_tuples(tuples)
...
def df_sub_bsl(df, part):
    ...
    if df_ref is None:
        ...
        df_ref1 = df_ref.loc[:, idx_ref_sub]
        df1 = df.loc[:, idx_df_sub]
        df_head = df.loc[:, idx_df_head]
        # df2 = df1.sub(df_ref1, level=1)
        # lexsorted df is not desired result, so use some workaround = =
        for idx in df1.index:
            for first, second in df1.columns:
                if first == 'OOC_GROUP':
                    df1.at[idx, (first, second)] = df1.loc[idx, (first, second)] - ref_dict[second]
                elif first in ['OVERALL_BOX_PLOT', 'FSV_BOX_PLOT', 'BSV_BOX_PLOT', 'CP_BOX_PLOT']:
                    # df1.at[idx, (first, second)] = df1.loc[idx, (first, second)] - ref_dict[second]
                    df1.at[idx, (first, second)] = 0
                else:
                    df1.at[idx, (first, second)] = df1.loc[idx, (first, second)] - df_ref1.loc[
...
10          NaN           NaN  Dec  296  0.947449  0.0525511  0.00414989  0.0191894  0.0292118       0.000872192     ...
    ...
    for first, second in result.columns:
        ...
        elif first in {'OVERALL_BOX_PLOT', 'FSV_BOX_PLOT', 'BSV_BOX_PLOT', "CP_BOX_PLOT", "OOC"}:
            result.at[tail_index, (first, second)] = np.nan
        else:
