...
# wm_OOR_HIGH_COLOR = wx.Colour(255, 20, 147, 255)  # pink
# wm_OOR_LOW_COLOR = wx.Colour(160, 160, 160, 255)  # gray
# wm_HIGH_COLOR = wx.Colour(255, 0, 0, 255)  # red
# wm_LOW_COLOR = wx.Colour(0, 0, 255, 255)  # blue

wm_OOR_HIGH_COLOR = wx.Colour(*cfg.cfg['map info']['default color(RGB)']['OOS high color'])  # pink
wm_OOR_LOW_COLOR = wx.Colour(*cfg.cfg['map info']['default color(RGB)']['OOS low color'])  # gray
wm_HIGH_COLOR = wx.Colour(*cfg.cfg['map info']['default color(RGB)']['High color'])  # red
wm_LOW_COLOR = wx.Colour(*cfg.cfg['map info']['default color(RGB)']['Low color'])  # blue
