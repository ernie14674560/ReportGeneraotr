...
# wm_OOR_LOW_COLOR = wx.Colour(255, 128, 0, 255)          # orange
wm_OOR_LOW_COLOR = wx.Colour(160, 160, 160, 255)  # gray
wm_HIGH_COLOR = wx.Colour(255, 0, 0, 255)  # red
# wm_HIGH_COLOR = wx.Colour(0, 255, 128, 255)             # light green
# wm_LOW_COLOR = wx.Colour(0, 192, 0, 255)               # dark green
# wm_LOW_COLOR = wx.Colour(128, 0, 255, 255)              # purple
