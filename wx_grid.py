...
class MyGrid(wx.grid.Grid):
    def __init__(self, parent, editable=False, hide_label=True):
    ...
    def on_cell_right_click(self, event):
        ...
        if self.editable:
            ...
            menus = [(wx.NewIdRef(), "Copy", self.copy)]
    ...
    def on_label_right_click(self, event):
        ...
        if self.editable:
            ...
            menus = [(wx.NewIdRef(), "Copy", self.copy), None]
...
class MyFrame(wx.Frame):
    def __init__(self, parent, ID, title, pos=wx.DefaultPosition, size=wx.Size(800, 400),
